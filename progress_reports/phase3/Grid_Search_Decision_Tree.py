...
plt.tight_layout()
plt.savefig('progress_reports/phase3/evaluations/Grid_Search_Decision_Tree.png', format='png', dpi=600)
...
# Save metrics to CSV
metrics_df.to_csv('progress_reports/phase3/evaluations/Grid_Search_Decision_Tree.csv')
...
plt.tight_layout()
plt.show()
plt.savefig('progress_reports/phase3/evaluations/Feature_Selection_Grid_Search_Decision_Tree.png', format='png', dpi=600)
