...
plt.savefig('progress_reports/phase3/evaluations/Decision_Tree.png', format='png', dpi=600)
...
# Save metrics to CSV
metrics_df.to_csv('progress_reports/phase3/evaluations/Decision_Tree.csv')
